...
## Локация и охват
Я базируюсь в **Казахстане** и работаю с проектами по всей **Европе**.

<p align="center">
  <img src="https://simplemaps.com/static/svg/world/world.svg" width="60%" style="filter: invert(1);">
  <br>
  <sub><i>Выделенные регионы: Казахстан (Центральная Азия) и Европа.</i></sub>
</p>
...
## Компетенции
- **Soft Skills:** Аналитическое мышление, управление полным циклом разработки (SDLC), менторство, инцидент-менеджмент.
